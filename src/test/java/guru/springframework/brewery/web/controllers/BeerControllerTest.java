...
class BeerControllerTest {
    ...
    // Se quita porque no es optimo usar esta funcionalidad
    ...
    public class TestListOperations {
        ...
        @Captor
        ArgumentCaptor<BeerStyleEnum> beerStyleEnummCaptor;
        ...
        void setUp() {
            ...
            given(beerService.listBeers(beerNameCaptor.capture(), beerStyleEnummCaptor.capture(), pageRequestCaptor.capture()))
